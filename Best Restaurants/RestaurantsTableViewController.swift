...
//        let chosenRestaurant = Restaurants.shared[indexPath.row].name
...
//    }
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        let restaurantsDetailsVC = segue.destination as! RestaurantDetailsViewController
        restaurantsDetailsVC.restaurant = Restaurants.shared[tableView.indexPathForSelectedRow!.row]
    }
